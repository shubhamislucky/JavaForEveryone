...
public class Switch extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView mytext1 = (TextView)rootView.findViewById(R.id.switch_one);
        TextView mytext2 = (TextView)rootView.findViewById(R.id.switch_two);
        TextView mytext3 = (TextView)rootView.findViewById(R.id.switch_three);
        TextView mytext4 = (TextView)rootView.findViewById(R.id.switch_four);
        TextView mytext5 = (TextView)rootView.findViewById(R.id.switch_five);
        TextView mytext6 = (TextView)rootView.findViewById(R.id.switch_six);
        TextView mytext7 = (TextView)rootView.findViewById(R.id.switch_seven);
